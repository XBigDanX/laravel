  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 flex items-center justify-center py-12 px-4">
      <div className="max-w-lg w-full bg-white rounded-3xl shadow-2xl p-10 border border-gray-100">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight drop-shadow-lg text-center">Create Product</h1>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" className="w-full bg-gradient-to-r from-indigo-600 to-pink-500 hover:from-indigo-700 hover:to-pink-600 text-white font-bold py-3 rounded-xl shadow-lg transition-all duration-200 text-lg focus:outline-none focus:ring-2 focus:ring-indigo-400">Create</button>
        </form>
      </div>
    </div>
  );
